...
**Contrato** `contracts/clientes/cadastro/contract.odcs.yaml` v1.0.0  
**sha256** `be59c5d71b2880ea6ed70b1372817566c5c12bd3e5a53e9bb748eff010a26281`
...
- 10 campo(s) analisado(s)
- 10 classificado(s) — 9 PII, 0 sensivel
- por nivel: 8 confidential, 1 internal, 1 restricted
- 0 sem classificacao
...
| `telefone` | `contato.telefone` | `confidential` | sim | nao | LGPD art. 5, I | Numero atribuido a uma linha individual e, no Brasil, vinculado a um CPF no cadastro da operadora. |
