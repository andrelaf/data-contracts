...
**Contrato** `contracts/vendas/pedidos/contract.odcs.yaml` v1.0.0  
**sha256** `7669eefdfb247a370e48bb1b2d341330ce8e07ee846662c86c3e6a9a791267d8`
...
5 item(ns), sob o pedido `64c8fbed43c16990`. Enquanto houver pendencia aqui, o campo correspondente **nao** recebe classificacao no contrato: o harness nao escreve "nao sei" num contrato de dados.

| Tipo | Campo | Detalhe |
|---|---|---|
| `lacuna` | `_id` | campo sem termo no glossario — segue sem classificacao no contrato ate decisao humana |
| `reclassificacao` | `cliente.cpf` | o contrato declara `internal, pii` e o catalogo diz `restricted, pii` |
